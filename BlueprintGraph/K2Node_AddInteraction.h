...
#include "K2Node.h"
#include "K2Node_AddInteraction.generated.h"
...
namespace GetDataTableRowHelper {
	const FName DataTablePinName = "DataTableInteractionSpec";
	const FName RowNotFoundPinName = "RowNotFound";
	const FName RowNamePinName = "RowName";
	const FName ActionPinName = "Action";
	const FName NamePinName = "Name";
	const FName InteractablePinName = "Interactable";
	const FName RunOnPlayPinName = "Run On Play";
	const FName ShowablePinName = "Showable";
	const FName WhenInventoryItemsPinName = "When Inventory Items";
	// const FName OutputInventoryItemsPinName = "Output Inventory Items";
	const FName FinalizeWithPinName = "Finalize With";
	const FName AutoPinName = "Auto";
}
 ...
 */
UCLASS()
class MUKA_API UK2Node_AddInteraction : public UK2Node
{
	...
	/** */
	UEdGraphPin* GetInteractionNamePin() const;
	/** */
	UEdGraphPin* GetInteractablePin() const;
	/** */
	UEdGraphPin* GetWhenInventoryItemsPin() const;
	/** */
	// UEdGraphPin* GetOutputInventoryItemsPin() const;
	/** */
	UEdGraphPin* GetFinalizeWithPin() const;
