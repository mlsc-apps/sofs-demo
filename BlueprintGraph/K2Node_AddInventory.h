...
#include "K2Node.h"
#include "K2Node_AddInventory.generated.h"

namespace AddInventoryPinNameHelper {
	const FName DataTablePin    = "InventoryItemList";
	const FName RowNamePin      = "InventoryItem";
	const FName InteractionPin  = "Interaction";
	const FName PreviousNodePin = "PreviousNode";

	const FName ActorTagPin     = "ActorTag";
	const FName DescriptionPin  = "Description";
	const FName InventoryItemNamePin = "Item Name";
 ...
 */
UCLASS()
class MUKA_API UK2Node_AddInventory : public UK2Node
{
